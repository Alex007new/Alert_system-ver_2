...
def get_alert_info():
    metrics_list = {
        'users_feed': {
            ...
            'table_name': 'simulator_20230320.feed_actions'
        },
        'likes': {
            'alias': 'likes',
        ...
        'users_msg': {
            ...
            'table_name': 'simulator_20230320.message_actions'
        },
        'messages': {
            'alias': 'messages',
    ...
    responsible_users = {
        "metrics" : {"users_msg": "@alex007new_bot"},
        "groups" : {"os": "@alex007new_bot", "source": "@alex007new_bot"}
    }
    alert_plots = {
        'total': {
            'users_feed': 'http://superset.lab.karpov.courses/r/3504',
            'likes': 'http://superset.lab.karpov.courses/r/3505',
            'views': 'http://superset.lab.karpov.courses/r/3506',
            'ctr': 'http://superset.lab.karpov.courses/r/3507',
            'vpu': 'http://superset.lab.karpov.courses/r/3508',
            'lpu': 'http://superset.lab.karpov.courses/r/3509',
            'users_msg': 'http://superset.lab.karpov.courses/r/3510',
            'messages': 'http://superset.lab.karpov.courses/r/3511',
            'mpu': 'http://superset.lab.karpov.courses/r/3512'
        },
        'os': {
            'users_feed': 'http://superset.lab.karpov.courses/r/3513',
            'likes': 'http://superset.lab.karpov.courses/r/3514',
            'views': 'http://superset.lab.karpov.courses/r/3515',
            'ctr': 'http://superset.lab.karpov.courses/r/3516',
            'vpu': 'http://superset.lab.karpov.courses/r/3517',
            'lpu': 'http://superset.lab.karpov.courses/r/3518',
            'users_msg': 'http://superset.lab.karpov.courses/r/3519',
            'messages': 'http://superset.lab.karpov.courses/r/3520',
            'mpu': 'http://superset.lab.karpov.courses/r/3521'
        },
        'source': {
            'users_feed': 'http://superset.lab.karpov.courses/r/3522',
            'likes': 'http://superset.lab.karpov.courses/r/3523',
            'views': 'http://superset.lab.karpov.courses/r/3524',
            'ctr': 'http://superset.lab.karpov.courses/r/3525',
            'vpu': 'http://superset.lab.karpov.courses/r/3526',
            'lpu': 'http://superset.lab.karpov.courses/r/3527',
            'users_msg': 'http://superset.lab.karpov.courses/r/3528',
            'messages': 'http://superset.lab.karpov.courses/r/3529',
            'mpu': 'http://superset.lab.karpov.courses/r/3530'
        }            
    }
...
def send_alert(plot_df, group, metric_name, metric_alias, slice_name, alert_plot, responsible_users, chat):
    ...
    dahsboard_link = 'https://superset.lab.karpov.courses/superset/dashboard/3206'
...
def global_monitoring(chat=None):
    chat_id = chat or 97693XXXX
    alerts = [
        {"mertics": ["users_feed", "likes", "views", "ctr"], "slice": "total"},
        {"mertics": ["users_feed", "likes", "views", "ctr"], "slice": "source"},
...
cq = '''CREATE TABLE simulator.alerts_log (
'time'          DateTime,
'day_0_value'   Float64,
'day_1_value'   Float64,
'day_7_value'   Float64,
...
ENGINE = MergeTree
ORDER BY (time, slice, metric, group_level)
